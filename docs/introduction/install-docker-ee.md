...
![docker-ee-content-not-find.png](./images/docker-ee-content-not-find.png)
...
![docker-ee-30-day-trial.png](./images/docker-ee-30-day-trial.png)

在 Docker Store 页面点击 [**Start 1 Month Trial**](https://store.docker.com/editions/enterprise/docker-ee-trial/trial)，然后会进入企业信息填写面板。

![docker-ee-start-1-Month-trial.png](./images/docker-ee-start-1-Month-trial.png)

![set-ee-info.png](./images/set-ee-info.png)

在信息面板提交后可返回自己的 [**Content**](https://store.docker.com/my-content) 面板，选择你在信息面板提交的组织，就能看到你的仓库信息。

![docker-ee-content.png](./images/docker-ee-content.png)

然后点击 **Setup** 进入仓库信息面板。

在右侧就能看到当前组织的仓库URL（`repo url`）。

![ee-repo-url.png](./images/ee-repo-url.png)
